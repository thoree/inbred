#'
#' Compare bootstrap CI-s (nonparametric, parametric) and assymptotic
#'
#' The
#'
...
#' theta = 0.5
#' seed = 17
#' compareCI(theta, x, ids, n, N, B, seed = seed)
...
findp = function(x, ids){
  ...
  tab0 = oneMarkerDistribution(x, ids = c(4,5),
